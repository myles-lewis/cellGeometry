...
cells is close to the vector for Tcm/Naive helper T cells.

The `diagnose()` function provides more thorough diagnostics. It can be used to
identify which cell clusters are problematic. Helper T cells in particular do
not have any top ranked markers of their own since they are largely identical to
Tcm/Naive helper T cells in terms of their gene expression.
