...
signature_heatmap(mkNN, use_filter = F)
```
...
signature_heatmap(mkm, top = 5, text = F,
                  show_row_names = F, row_title_rot = 0, column_title_rot = 45)

signature_heatmap(mkm, text = F, outlines = T, outline_col = "purple2",
                  show_row_names = F, row_title_rot = 0, column_title_rot = 45,
                  scale = "sphere")

mk <- updateMarkers(mk, expfilter = 0.1)
signature_heatmap(mk, text = F, outlines = T, outline_col = "purple2",
                  show_row_names = F, row_title_rot = 0, column_title_rot = 45,
                  scale = "sphere")

signature_heatmap(mkm, subset = "Amygdala excitatory")
signature_heatmap(mkm, type = "group")
```
...
# sample from original non-neuronal sc dataset
# 6.32 mins (Intel)
...
Finally we compare with ground truth and generate scatter plots comparing ground
truth cell counts/percentages against the deconvolution predictions.
